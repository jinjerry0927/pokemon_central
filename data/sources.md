...
| `serebii-champions-pokedex` | Serebii Champions Pokédex | 현재 포켓몬·폼별 기술 후보와 이전 커뮤니티 스냅샷의 변경점 확인 | 첫 커뮤니티 데이터셋이 Serebii를 원본으로 명시하므로 독립 검증으로 보지 않는다. 기술 설명은 복사하지 않고 기술 ID만 보관한다. |
