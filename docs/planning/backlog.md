...
| FB-UI-001 | UI | 공통 디자인 시스템 리프레시와 홈 빠른 시작 허브 개선 | 1 | P2 | Done | 2026-07-01 / Planning; `npm.cmd run data:validate`, `npm run lint`, `npm run build` |
...
| 2 | FB-UI-001 | P2, 사용률 인사이트 이후 홈 진입 흐름과 공통 UI 기준 정리가 필요 | Done |
